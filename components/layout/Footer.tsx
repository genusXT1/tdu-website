      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-16 mb-20">
          ...
          <div className="md:col-span-1">
            <img src={data.logoUrl || "https://www.uni-ruse.bg/_layouts/15/images/UniRuse/ru-default-logo.png"} alt="Uni Ruse" className="h-10 brightness-200 mb-8" />
            <p className="text-white/40 text-[10px] leading-loose uppercase tracking-widest font-black">
              {data.universityName?.[lang] || APP_CONFIG.universityName[lang]}<br/>

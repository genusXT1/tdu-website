...
const Museum: React.FC<MuseumProps> = ({ lang }) => {
  ...
  const t = {
    ...
    RO: {
      ...
      subtitle: 'Muzeul etnografic de studiu al filialei',
      tag: 'Patrimoniu cultural',
      history: 'Creat la inițiativa prof. dr. N. D. Rusev și a prof. dr. N. N. Cervencov, de un grup de lucru cu participarea masteranzilor N. N. Caracaș și N. N. Mostovoi.',
      mission: 'Misiunea muzeului este studiul, cercetarea, colectarea, conservarea, restaurarea și expunerea monumentelor culturale mobile care reflectă manifestările creative ale diasporei bulgare.',
      sections: [
        { title: 'Bucătăria', desc: 'Obiectele tradiționale și amenajarea unei bucătării casnice.' },
        { title: 'Dormitorul', desc: 'Amenajarea autentică a unui spațiu de dormit.' },
        { title: 'Echipamente casnice', desc: 'Uneltele și obiectele de uz zilnic ale bulgarilor basarabeni.' }
      ],
      personnel: 'Personal',
      guide: 'Ghidul muzeului: Asistent Nicolae Nicolaevici Mostovoi',
      hours: 'Program de lucru: 8:00 - 17:00',
      lunch: 'Pauza de masă: 12:00 - 13:00',
      galleryTitle: 'Galeria foto a muzeului'
    },
    EN: {
      title: 'Ethnographic Museum',
      subtitle: 'Educational ethnographic museum of the branch',
      tag: 'Cultural Heritage',
      history: 'Created at the initiative of Prof. N. D. Rusev and Prof. N. N. Chervenkov, by a working group with the participation of master students N. N. Karakash and N. N. Mostovoy.',
      mission: 'The mission of the museum is to study, research, collect, conserve, restore and exhibit easily movable cultural objects reflecting the creative manifestations of the Bulgarian diaspora.',
      sections: [
        { title: 'Kitchen', desc: 'Traditional objects and the arrangement of a domestic kitchen.' },
        { title: 'Bedroom', desc: 'Authentic layout of a sleeping area.' },
        { title: 'Household Equipment', desc: 'Tools and everyday items of the Bessarabian Bulgarians.' }
      ],
      personnel: 'Personnel',
      guide: 'Museum guide: Assistant Nikolay Nikolaevich Mostovoy',
      hours: 'Opening hours: 8:00 - 17:00',
      lunch: 'Lunch break: 12:00 - 13:00',
      galleryTitle: 'Museum Photo Gallery'
    }
  }[lang] || { title: 'Museum', galleryTitle: 'Gallery', sections: [] };

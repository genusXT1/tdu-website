...
const About: React.FC<AboutProps> = ({ lang }) => {
  ...
  const t = {
    BG: {
      ...
      qualityDesc: `${universityName} гарантира високи стандарти на обучение за българската общност и гражданите на Молдова.`,
    ...
    RU: {
      ...
      qualityDesc: `${universityName} гарантирует высокие стандарты обучения для болгарской общины и граждан Молдовы.`,
    ...
    RO: {
      ...
      qualityDesc: `${universityName} garantează standarde înalte de educație pentru comunitatea bulgară și cetățenii Moldovei.`,
    ...
    EN: {
      ...
      qualityDesc: `${universityName} guarantees high standards of education for the Bulgarian community and citizens of Moldova.`,
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          >
            <span className="inline-block px-4 py-1.5 mb-6 text-[10px] font-black tracking-[0.3em] uppercase bg-[#FFCC00] text-[#003366] rounded-full">
              {lang === 'BG' ? 'Официално представителство' : lang === 'RU' ? 'Официальное представительство' : lang === 'RO' ? 'Reprezentanță Oficială' : 'Official Representation'}
            </span>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-10 serif italic flex items-center gap-3">
                ...
                {lang === 'BG' ? 'Хронология' : lang === 'RU' ? 'Хронология' : lang === 'RO' ? 'Cronologie' : 'Timeline'}
              </h3>
            ...
            >
              ...
              <p className="text-sm font-medium leading-relaxed opacity-80">
                {lang === 'BG'
                  ? 'Тази устойчива структура гарантира европейско бъдеще за студентите, превръщайки Тараклия в академичен център от европейско значение.'
                  : lang === 'RU'
                    ? 'Эта устойчивая структура гарантирует европейское будущее для студентов, превращая Тараклию в академический центр европейского значения.'
                    : lang === 'RO'
                      ? 'Această structură durabilă garantează un viitor european pentru studenți, transformând Taraclia într-un centru academic de importanță europeană.'
                      : 'This sustainable structure guarantees a European future for students, transforming Taraclia into an academic center of European significance.'}
              </p>
            </motion.div>
          </div>

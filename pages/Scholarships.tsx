            ...
            <div className="bg-white/5 backdrop-blur-md rounded-[2.5rem] p-10 border border-white/10">
              ...
              <p className="text-sm leading-relaxed opacity-90">
                {lang === 'BG'
                  ...
                  : lang === 'RU'
                    ? 'Стипендии выплачиваются безналичным путем на банковский счет. Студенты должны предоставить IBAN в сектор "Стипендии".'
                    : lang === 'RO'
                      ? 'Bursele sunt plătite prin transfer bancar. Studenții trebuie să prezinte IBAN-ul la sectorul "Burse".'

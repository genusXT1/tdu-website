...
const Regulations: React.FC<RegulationsProps> = ({ lang }) => {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snapshot) => {
      ...
      console.error("Firestore error in Regulations:", error);
      setLoading(false);
    });
    return () => unsub();
  }, []);
  ...
  const t = {
    ...
    RO: {
      ...
      subtitle: 'Documente oficiale și regulamente care reglementează activitatea universității și a subdiviziunilor sale',
      featured: 'Regulamente de bază',
      other: 'Alte documente',
      download: 'Deschide PDF',
      readMore: 'Citește mai mult',
      lastUpdated: 'Ultima actualizare',
      loading: 'Se încarcă documentele...',
      noDocs: 'Nu au fost găsite documente'
    },
    EN: {
      title: 'Regulations',
      subtitle: 'Official documents and regulations governing the activities of the university and its branches',
      featured: 'Main Regulations',
  ...
  const featuredDocs = [
    {
      title: lang === 'BG'
        ...
        : lang === 'RU'
          ...
          : lang === 'RO'
            ? 'REGULAMENTUL de activitate al Universității din Ruse „Angel Kanchev”'
            : 'REGULATIONS for the activities of the University of Ruse "Angel Kanchev"',
      year: '2022',
      desc: lang === 'BG'
        ...
        : lang === 'RU'
          ...
          : lang === 'RO'
            ? 'Act normativ de bază care definește structura, conducerea și organizarea întregii universități.'
            : 'Basic initial act defining the structure, management, and organization of the whole university.',

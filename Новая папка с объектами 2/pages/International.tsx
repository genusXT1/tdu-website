    ...
    <div className="page-transition min-h-screen bg-white">
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {[
            { 
              title: lang === 'BG' ? 'Мобилност' : 'Мобильность', 
              desc: lang === 'BG' ? 'Възможности за краткосрочни специализации.' : 'Возможности для краткосрочных специализаций.',
              icon: Globe
            },
            { 
              title: lang === 'BG' ? 'Проекти' : 'Проекты', 
              desc: lang === 'BG' ? 'Участие в международни научни мрежи.' : 'Участие в международных научных сетях.',
              icon: ExternalLink
            },
            { 
              title: lang === 'BG' ? 'Сертификати' : 'Сертификаты', 
              desc: lang === 'BG' ? 'Международно признати сертификати.' : 'Международно признанные сертификаты.',
              icon: CheckCircle2
            }
          ].map((item, i) => {

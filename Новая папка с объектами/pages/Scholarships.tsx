...
const Scholarships: React.FC<{ lang: Language }> = ({ lang }) => {
  ...
  const types = [
    { title: 'Стипендии за успех и доход', desc: 'За български студенти, редовна форма на обучение.' },
    { title: 'Стипендии за чуждестранни студенти', desc: 'Приети по междуправителствени спогодби.' },
    { title: 'Социални стипендии', desc: 'За студенти с трайни увреждания, сираци и други категории.' },
    { title: 'За значими постижения', desc: 'В научноизследователската, спортната и художествената дейност.' }
  ];

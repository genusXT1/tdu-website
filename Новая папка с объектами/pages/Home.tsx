...
const Home: React.FC<HomeProps> = ({ lang }) => {
  ...
  const t = {
    BG: {
      hero: "Европейско бъдеще в Тараклия",
      heroSub: "Държавна диплома на Република България, призната в целия ЕС.",
    ...
    RU: {
      hero: "Европейское будущее в Тараклии",
      heroSub: "Государственный диплом Республики Болгария, признанный во всем ЕС.",
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center bg-slate-900 overflow-hidden">
        ...
        >
          <img 
            src="https://radika1.link/2025/12/26/545842530_1297136775540313_8922887932559365527_nd1314a5f1078582c.jpg" 
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-wrap justify-center gap-12 md:gap-24 items-center">
              {partners.map((partner, idx) => (
                <div key={idx} className="group flex items-center justify-center transition-all duration-300 transform hover:scale-110">
                  <img src={partner.logo} className="h-12 md:h-16 w-auto object-contain grayscale opacity-40 group-hover:opacity-100 transition-all" alt={partner.name} referrerPolicy="no-referrer" />
                </div>
              ))}
            </div>
          </div>
